...
void KeyExpansion(unsigned char* inputKey,unsigned char* expandedKeys)
{
  ...
  for(int i=0;i<16;i++)
   ...
   while(bytesgenerated<176)
   {
     ...
     {
       expandedKeys[bytesgenerated]=temp[a]^expandedKeys[bytesgenerated-16];
       bytesgenerated++;
     }
   }
}
  ...
  for(int i=0;i<numOfRounds;i++)
{
  ...
  AddRoundKey(state,expandedKeys + (16*(9-i)));
...
int main()
{
  unsigned char message[]="Two one nine six";
 ...
 AES_Decrypt(message,expandedKeys+160);
